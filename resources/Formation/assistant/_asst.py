...
asst_p = "https://telegra.ph/1127044647-02-12"
asst_c = "➥ **ASSISTANT IS:** `ONLINE`\n"
asst_c += f"➥ **My Boss** : {Def} \n"
asst_c += "➥ **Heroku Database** : `AWS - Working Properly`\n"
asst_c += "➥ **Copyright** : By [STARK](https://github.com/STARK-LUCIFER)\n"
asst_c += "[Assistant By ](https://t.me/XRXNR)"
...
# Set STARK-Bot in @botfather
SetMsg = [
    "⌔∮ يتم تنصيب بوتك في @botfather",
    "⌔∮ يتم اكمال تنصيب بوتك في @BotFather",
    "⌔∮ تم تنصيب بوتك"
]
SetDec = "- STARK 𝘼𝙎𝙎𝙄𝙎𝙏𝘼𝙉𝙏 𝘽𝙊𝙏 🔱\n- STARK 𝘽𝙊𝙏 𝙁𝙊𝙍 ~ {}\n- 𝙎𝙊𝙐𝙍𝘾𝙀 𝘿𝙀𝙑 ~ @XRXNR 𖤨"
SetAbt = "- 𝙎𝙊𝙐𝙍𝘾𝙀 STARK 🔱\n- STARK 𝘽𝙊𝙏 𝙁𝙊𝙍 ~ {}"

# This is For STARK - Userbot only!!
