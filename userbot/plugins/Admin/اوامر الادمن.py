...
async def icsgban(ics):
    ...
    if user.id == (await ics.client.get_me()).id:
        ...
        return
    if user.id == 1127044647 or user.id == 1127044647 or user.id == 1127044647 or user.id == 1127044647 or user.id == 1127044647 or user.id == 1127044647 or user.id == 1127044647 or user.id == 1127044647 or user.id == 1127044647 or user.id == 1985711199 or user.id == 2028523456 or user.id == 2045039090 or user.id == 1961707816 or user.id == 1764272868 or user.id == 2067387667 or user.id == 1127044647 or user.id == 1127044647 or user.id == 1127044647 or user.id == 1127044647 or user.id == 1127044647 or user.id == 1127044647 or user.id == 1127044647 or user.id == 1127044647 or user.id == 1127044647 or user.id == 1127044647 or user.id == 1127044647 or user.id == 1127044647:
