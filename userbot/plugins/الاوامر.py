# commands for source ZED by ~ @XRXNR
...
async def _(event):
    ...
    if input_str == "م1":
        ...
        if r == 0:
            await event.edit(
                "𓆰 [𝑺𝑶𝑼𝑹𝑪𝑬 STARK𝙏𝙃𝙊𝙉 - 𝑪𝑶𝑴𝑴𝑨𝑵𝑫𝑺](t.me/XRXNR) 𓆪\n **⌔╎قائـمه اوامر الادمن :** \n⪼ `.حظر` \n⪼ `.الغاء حظر` \n⪼ `.تقيد` \n⪼ `.الغاء تقيد` \n⪼ `.رفع القيود` \n⪼ `.كتم` \n⪼ `.الغاء كتم` \n⪼ `.تثبيت` \n⪼ `.الغاء التثبيت` \n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 STARK𝙏𝙃𝙊𝙉](t.me/XRXNR) 𓆪"
            )
        else:
            await event.edit(
                "𓆰 [𝑺𝑶𝑼𝑹𝑪𝑬 STARK𝙏𝙃𝙊𝙉 - 𝑪𝑶𝑴𝑴𝑨𝑵𝑫𝑺](t.me/XRXNR) 𓆪\n **⌔╎قائـمه اوامر الادمن :** \n⪼ `.حظر` \n⪼ `.الغاء حظر` \n⪼ `.تقيد` \n⪼ `.الغاء تقيد` \n⪼ `.رفع القيود` \n⪼ `.كتم` \n⪼ `.الغاء كتم` \n⪼ `.تثبيت` \n⪼ `.الغاء التثبيت` \n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 STARK𝙏𝙃𝙊𝙉](t.me/XRXNR) 𓆪"
...
########################  SOURCE STARK𝙏𝙃𝙊𝙉 ~ BY: XRXNR (@XRXNR)  ########################
...
async def _(zed):
    await eor(zed, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 STARK - 𝑪𝑶𝑴𝑴𝑨𝑵𝑫𝑺](t.me/XRXNR) 𓆪\n **⌔╎قائـمه اوامر الترحيب :** \n⪼ `.ترحيب ` \n⪼ `.حذف ترحيب ` \n⪼ `.الترحيب `\n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 STARK](t.me/XRXNR) 𓆪")
...
async def _(zed):
    await eor(zed, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 STARK - 𝑩𝑳𝑨𝑪𝑲𝑳𝑰𝑺𝑻](t.me/XRXNR) 𓆪\n **⌔╎القائمة السوداء :** \n⪼ `.منع كلمه + الكلمه ` لمنع كلمه  \n⪼ `.الغاء منع + الكلمه` \n⪼ `.الكلمات المحظوره` \n⪼ `.ازعاج` \n⪼ `.الغاء ازعاج` \n⪼ `.قائمة الازعاج` \n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 STARK](t.me/XRXNR) 𓆪")
...
async def _(zed):
    await eor(zed, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 STARK - 𝑫𝑬𝑽𝑬𝑳𝑶𝑷𝑬𝑹](t.me/XRXNR) 🧸♥️𓆪\n**𓍹━─━─━─━─STARK─━─━─━─━𓍻**\n **𓄂**╺  𝑫𝑬𝑽 ❶╰──► @ZZZZl1l ༗\n\n **𓄂**╺  𝑫𝑬𝑽 ❷╰──► 𝒅𝒆𝒆𝒑 𝒘𝒐𝒖𝒏𝒅⍣°.²°²¹🦋… ༗\n\n **𓄂**╺  𝑫𝑬𝑽 ❸╰──► @HHHl1l ༗")
...
async def _(zed):
    await eor(zed, "𓆰 [𝙎𝙊𝙐𝙍𝘾𝞝 STARK - 𝘿𝙀𝙇𝙀𝙏𝙀](t.me/XRXNR) 🗑♻️𓆪\n**𓍹━─━─━─━─STARK─━─━─━─━𓍻**\n\n **✵│رابـط الحـذف ↬** https://telegram.org/deactivate \n\n\n **✵│بـوت الحـذف  ↬** @LC6BOT ")
...
DEFAULTUSER = "STARK"
CAT_IMG = "https://telegra.ph/1127044647-02-12"
CUSTOM_ALIVE_TEXT = "𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 STARK - 𝑫𝑬𝑽??𝑳𝑶𝑷𝑬𝑹 𓆪"
EMOJI = "  𓄂† "
...
async def dev(alive):
    ...
    if CAT_IMG:
        ...
        cat_caption += f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧSTARKⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n"
        cat_caption += f"**{EMOJI}** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 1 ↬ @XRXNR ༗\n"
        cat_caption += f"**{EMOJI}** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 2 ↬ @XRXNR ༗\n"
        cat_caption += f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧSTARKⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻"
        ...
        await edit_or_reply(
            alive,
            f"**{CUSTOM_ALIVE_TEXT}**\n"
            f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧSTARKⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n"
            f"**{EMOJI}** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 1 ↬ @XRXNR ༗\n"
            f"**{EMOJI}** 𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 2 ↬ @XRXNR ༗\n"
            f"𓍹ⵧⵧⵧⵧⵧⵧⵧⵧSTARKⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻",
        )
