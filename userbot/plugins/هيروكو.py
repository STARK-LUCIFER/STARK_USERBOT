...
async def variable(var):
    ...
    if exe == "جلب":
        ...
        try:
            ...
            if variable in heroku_var:
                return await ics.edit(
                    "𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 STARK𝙏𝙃𝙊𝙉 - 𝑮𝑶𝑵𝑭𝑰𝑮 𝑽𝑨𝑹𝑺 𓆪\n𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻"
        ...
        if variable in heroku_var:
            await ics.edit("**⌔∮ تم تغيـر** `{}` **:**\n **- المتغير :** `{}` \n**- يتم الان اعـادة تشغيـل بـوت ستارك يستغـرق الامر 2-1 دقيقـه ▬▭ ...**".format(variable, value))
        else:
        ...
        await ics.edit(f"**⌔∮** `{variable}`  **تم حذفه بنجاح. \n**يتم الان اعـادة تشغيـل بـوت ستارك يستغـرق الامر 2-1 دقيقـه ▬▭ ...**")
...
async def _(dyno):
    ...
    try:
        ...
        return await dyno.reply(
            "**- عذرا لا يمكنك استخدام اوامر الفارات وهيروكو الا بعد اضافة كود هيروكو الى الفارات شرح الاضافة [اضغط هنا](https://t.me/XRXNR)**"
        )
    data = app.get_log()
    await edit_or_reply(
