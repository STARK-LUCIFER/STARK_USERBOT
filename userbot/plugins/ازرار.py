...
# button post makker for XRXNR thanks to uniborg for the base
...
CMD_HELP.update(
    ...
    \n•  **Example :** `.كول + الجمله المراد اظهارها [المطـور]<buttonurl:https://t.me/XRXNR> [ستارك]<buttonurl:https://t.me/XRXNR> [اوامر السورس]<buttonurl:https://t.me/XRXNR>`\
    \n\n•  **Syntax : **`.كوول`\
    \n•  **Function :** __Buttons must be in the format as [Name on button]<buttonurl:link you want to open>__\
    \n•  **Example :** `.كوول + الجمله المراد اظهارها [المطـور]<buttonurl:https://t.me/XRXNR> [ستارك]<buttonurl:https://t.me/XRXNR> [اوامر السورس]<buttonurl:https://t.me/XRXNR>`\
    "
    }
)
