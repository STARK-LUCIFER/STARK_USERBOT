...
class Config(object):
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/STARK-LUCIFER/STARK_USERBOT.git"
    )
    ...
    CUSTOM_ALIVE_EMSTARK = os.environ.get("CUSTOM_ALIVE_EMSTARK", None)
    ...
    THUMB_IMAGE = os.environ.get(
        "THUMB_IMAGE", "https://telegra.ph/1127044647-02-12"
    )
    UB_BLACK_LIST_CHAT = {
    ...
    STARK_MEDIA = os.environ.get("STARK_MEDIA", None)
