...
DEFAULTUSER = str(ALIVE_NAME) if ALIVE_NAME else "STARK Userbot"
...
# Dev tag
tosh = ( 
    "𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 STARK - 𝑫𝑬𝑽𝑬𝑳𝑶𝑷𝑬𝑹 𓆪\n"
    "𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧSTARKⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻\n"
    "𓄂†  𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 1 ↬ @XRXNR ༗\n"
    "𓄂†  𝑫𝑬𝑽 𝑼𝑺𝑬𝑹 2 ↬ @BBLBB0 ༗\n"
    "𓍹ⵧⵧⵧⵧⵧⵧⵧⵧⵧSTARKⵧⵧⵧⵧⵧⵧⵧⵧⵧ𓍻"
)
...
# بلاي 
R = (
    "**𓆰**  𝙎𝙊𝙐𝙍𝘾𝙀 STARK   **العـاب الاونلايـن** 🎮𓆪 \n"
    "◐━─━─━─━─STARK─━─━─━─━◐\n\n"
    ...
    "**𓄂-** 𝙎𝙊𝙐𝙍𝘾𝙀 𝘿𝙀𝙑 **⪼**  [𐇮 STARK لوسيفر 𐇮](t.me/XRXNR)   \n"
    "**𓆰** 𝙎𝙊𝙐𝙍𝘾𝙀 𝙍𝙀𝙋𝙊 **⪼**  [STARK](https://t.me/XRXNR/102)  "
)
K = "https://github.com/STARK-LUCIFER/STARK_USERBOT"

# Alive Bot 
TOSH = (
       f"**⌔∮ بوت ستارك يعمل بنجاح 🖤❕**\n"
