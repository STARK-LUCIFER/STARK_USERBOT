...
ICS_ID = ["1127044647", "1127044647"]

# for print :
usr = "STARK USERBOT -{}".format(Tlk)
adn = "STARK ADMIN TOOLS -{}".format(Tlk)
ani = "STARK ANIMATIONS -{}".format(Tlk)
tsh = "STARK TOSHA -{}".format(Tlk)
ast = "STARK ASSISTANT -{}".format(Tlk)
pmt = "STARK ASSISTANT PM -{}".format(Tlk)
